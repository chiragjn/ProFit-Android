...
public class ExpandingListView extends ListView {
    ...
    private AdapterView.OnItemClickListener mItemClickListener = new AdapterView
        ...
        public void onItemClick (AdapterView<?> parent, View view, int position, long id) {
            SuggestionExpandingListViewItem viewObject = (SuggestionExpandingListViewItem)getItemAtPosition(getPositionForView
                    (view));
    ...
    private void expandView(final View view) {
        final SuggestionExpandingListViewItem viewObject = (SuggestionExpandingListViewItem)getItemAtPosition(getPositionForView
                (view));
